...
public final class GameData 
{
	...
	private void createAttacks(Window win)
	{
		...
		this.allAtks[i] = new Attack("Absorb", "User recovers half the HP inflicted on opponent.", i, 20, 25, false, this.allTypes[10],44,100,100); i++;
		this.allAtks[i] = new Attack("Acid", "May lower opponent's Special.", i, 40, 30, false, this.allTypes[3],32,10,100); i++;
		this.allAtks[i] = new Attack("Acid Armor", "Sharply raises user's Defense.", i, 0, 20, false, this.allTypes[3],21,100,100); i++;
		this.allAtks[i] = new Attack("Agility", "Sharply raises user's Speed.", i, 0, 30, false, this.allTypes[12],29,100,100); i++;
		this.allAtks[i] = new Attack("Amnesia", "Sharply raises user's Special.", i, 0, 20, false, this.allTypes[12],21,100,100); i++;
		this.allAtks[i] = new Attack("Aurora Beam", "May freeze the opponent", i, 65, 20, false, this.allTypes[13],5,10,100); i++;
		this.allAtks[i] = new Attack("Barrage", "Hits 2-5 times in one turn.", i, 15, 20, true, this.allTypes[0],46,100,85); i++;
		this.allAtks[i] = new Attack("Barrier", "Sharply raises user's Defense.", i, 0, 20, false, this.allTypes[12],21,100,100); i++;
		this.allAtks[i] = new Attack("Bide", "User takes damage for two turns then strikes back double.", i, 0, 10, true, this.allTypes[10],54,100,100); i++;
		this.allAtks[i] = new Attack("Bite", "May cause flinching", i, 60, 25, true, this.allTypes[0],43,30,100); i++;
		this.allAtks[i] = new Attack("Blizzard", "May freeze opponent.", i, 110, 5, false, this.allTypes[13],5,10,70); i++;
		this.allAtks[i] = new Attack("Body Slam", "May paralyze opponent.", i, 85, 15, true, this.allTypes[0],1 ,30,100); i++;
		this.allAtks[i] = new Attack("Bone Club", "May cause flinching.", i, 65, 20, true, this.allTypes[4],43,10,85); i++;
		this.allAtks[i] = new Attack("Bonemerang", "Hits twice in one turn.", i, 50, 10, true, this.allTypes[4],0,100,90); i++;
		this.allAtks[i] = new Attack("Bubble", "May lower opponent's Speed.", i, 40, 30, false, this.allTypes[9],24,10,100); i++;
		this.allAtks[i] = new Attack ("Bubble Beam","May lower opponent's Speed.",i,65,20,false,this.allTypes[9],24,10,100); i++;
		this.allAtks[i] = new Attack ("Clamp","Traps opponent, damaging them for 4-5 turns.",i,35,10,true,this.allTypes[9],55,0,85); i++;
		this.allAtks[i] = new Attack ("Comet Punch","Hits 2-5 times in one turn.",i,18,15,true,this.allTypes[0],46,0,85); i++;
		this.allAtks[i] = new Attack ("Confuse Ray","Confuses opponent.",i,0,10,false,this.allTypes[7],6,100,100); i++;
		this.allAtks[i] = new Attack ("Confusion","May confuse opponent.",i,50,25,false,this.allTypes[12],6,10,100); i++;
		this.allAtks[i] = new Attack ("Constrict","May lower opponent's Speed by one stage.",i,10,35,true,this.allTypes[0],24,10,100); i++;
		this.allAtks[i] = new Attack ("Conversion","Changes user's type to that of its first move.",i,0,30,false,this.allTypes[0],54,0,100); i++;
		this.allAtks[i] = new Attack ("Counter","When hit by a Physical Attack, user strikes back with 2x power.",i,0,20,true,this.allTypes[1],54,0,100); i++;
		this.allAtks[i] = new Attack ("Crabhammer","High critical hit ratio.",i,100,10,true,this.allTypes[9],47,1000,90); i++;
		this.allAtks[i] = new Attack ("Cut","Standard attack",i,50,30,true,this.allTypes[0],0,0,95); i++;
		this.allAtks[i] = new Attack ("Defense Curl","Raises user's Defense.",i,0,40,false,this.allTypes[0],17,1000,100); i++;
		this.allAtks[i] = new Attack ("Dig","Digs underground on first turn, attacks on second. Can also escape from caves.",i,80,10,true,this.allTypes[4],48,100,100); i++;
		this.allAtks[i] = new Attack ("Disable","Opponent can't use its last attack for a few turns.",i,0,20,false,this.allTypes[0],54,0,100); i++;
		this.allAtks[i] = new Attack ("Dizzy Punch","May confuse opponent.",i,70,10,true,this.allTypes[0],6,20,100); i++;
		this.allAtks[i] = new Attack ("Double Kick","Hits twice in one turn.",i,30,30,true,this.allTypes[1],46,0,100); i++;
		this.allAtks[i] = new Attack ("Double Slap","Hits 2-5 times in one turn.",i,15,10,true,this.allTypes[0],46,0,85); i++;
		this.allAtks[i] = new Attack ("Double Team","Raises user's Evasiveness.",i,0,15,false,this.allTypes[0],54,0,100); i++;
		this.allAtks[i] = new Attack ("Double-Edge","User receives recoil damage.",i,100,15,true,this.allTypes[0],49,0,100); i++;
		this.allAtks[i] = new Attack ("Dragon Rage","Always inflicts 40 HP.",i,0,10,false,this.allTypes[14],53,0,100); i++;
		this.allAtks[i] = new Attack ("Dream Eater","User recovers half the HP inflicted on a sleeping opponent.",i,100,15,false,this.allTypes[12],54,0,100); i++;
		this.allAtks[i] = new Attack ("Drill Peck","Standard attack",i,80,20,true,this.allTypes[2],0,0,100); i++;
		this.allAtks[i] = new Attack ("Earthquake","Power is doubled if opponent is underground from using Dig.",i,100,10,true,this.allTypes[4],54,0,100); i++;
		this.allAtks[i] = new Attack ("Egg Bomb","Standard attack",i,100,10,true,this.allTypes[0],0,0,75); i++;
		this.allAtks[i] = new Attack ("Ember","May burn opponent.",i,40,25,false,this.allTypes[8],4,10,100); i++;
		this.allAtks[i] = new Attack ("Explosion","User faints.",i,250,5,true,this.allTypes[0],50,0,100); i++;
		this.allAtks[i] = new Attack ("Fire Blast","May burn opponent.",i,110,5,false,this.allTypes[8],4,10,85); i++;
		this.allAtks[i] = new Attack ("Fire Punch","May burn opponent.",i,75,15,true,this.allTypes[8],4,10,100); i++;
		this.allAtks[i] = new Attack ("Fire Spin","Traps opponent, damaging them for 4-5 turns.",i,35,15,false,this.allTypes[8],55,0,85); i++;
		this.allAtks[i] = new Attack ("Flamethrower","May burn opponent.",i,90,15,false,this.allTypes[8],4,10,100); i++;
		this.allAtks[i] = new Attack ("Flash","Lowers opponent's Accuracy.",i,0,20,false,this.allTypes[0],40,100,100); i++;
		this.allAtks[i] = new Attack ("Fly","Flies up on first turn, attacks on second turn.",i,90,15,true,this.allTypes[2],48,0,95); i++;
		this.allAtks[i] = new Attack ("Fury Attack","Hits 2-5 times in one turn.",i,15,20,true,this.allTypes[0],46,0,85); i++;
		this.allAtks[i] = new Attack ("Fury Swipes","Hits 2-5 times in one turn.",i,18,15,true,this.allTypes[0],46,0,80); i++;
		this.allAtks[i] = new Attack ("Glare","Paralyzes opponent.",i,0,30,false,this.allTypes[0],1,100,100); i++;
		this.allAtks[i] = new Attack ("Growl","Lowers opponent's Attack.",i,0,40,false,this.allTypes[0],8,100,100); i++;
		this.allAtks[i] = new Attack ("Growth","Raises user's Attack and SpecialAttack.",i,0,40,false,this.allTypes[0],9,100,100); i++;
		this.allAtks[i] = new Attack ("Gust","Hits Pokémon using Fly/Bounce with double power.",i,40,35,false,this.allTypes[2],0,0,100); i++;
		this.allAtks[i] = new Attack ("Harden","Raises user's Defense.",i,0,30,false,this.allTypes[0],17,100,100); i++;
		this.allAtks[i] = new Attack ("Haze","Resets all stat changes.",i,0,30,false,this.allTypes[13],45,100,100); i++;
		this.allAtks[i] = new Attack ("Headbutt","May cause flinching.",i,70,15,true,this.allTypes[0],43,30,100); i++;
		this.allAtks[i] = new Attack ("High Jump Kick","If it misses, the user loses half their HP.",i,130,10,true,this.allTypes[1],0,0,90); i++;
		this.allAtks[i] = new Attack ("Horn Attack","Standard attack",i,65,25,true,this.allTypes[0],0,0,100); i++;
		this.allAtks[i] = new Attack ("Hydro Pump","Standard attack",i,110,5,false,this.allTypes[9],0,0,80); i++;
		this.allAtks[i] = new Attack ("Hyper Beam","User must recharge next turn.",i,150,5,false,this.allTypes[0],54,0,90); i++;
		this.allAtks[i] = new Attack ("Hyper Fang","May cause flinching.",i,80,15,true,this.allTypes[0],43,10,90); i++;
		this.allAtks[i] = new Attack ("Hypnosis","Puts opponent to sleep.",i,0,20,false,this.allTypes[12],2,100,60); i++;
		this.allAtks[i] = new Attack ("Ice Beam","May freeze opponent.",i,90,10,false,this.allTypes[13],5,10,100); i++;
		this.allAtks[i] = new Attack ("Ice Punch","May freeze opponent.",i,75,15,true,this.allTypes[13],5,10,100); i++;
		this.allAtks[i] = new Attack ("Jump Kick","If it misses, the user loses half their HP.",i,100,10,true,this.allTypes[1],0,0,95); i++;
		this.allAtks[i] = new Attack ("Karate Chop","High critical hit ratio.",i,50,25,true,this.allTypes[1],47,100,100); i++;
		this.allAtks[i] = new Attack ("Kinesis","Lowers opponent's Accuracy.",i,0,15,false,this.allTypes[12],40,100,80); i++;
		this.allAtks[i] = new Attack ("Leech Life","User recovers half the HP inflicted on opponent.",i,80,10,true,this.allTypes[6],44,100,100); i++;
		this.allAtks[i] = new Attack ("Leech Seed","Drains HP from opponent each turn.",i,0,10,false,this.allTypes[10],54,100,90); i++;
		this.allAtks[i] = new Attack ("Leer","Lowers opponent's Defense.",i,0,30,false,this.allTypes[0],16,100,100); i++;
		this.allAtks[i] = new Attack ("Lick","May paralyze opponent.",i,30,30,true,this.allTypes[7],1,30,100); i++;
		this.allAtks[i] = new Attack ("Light Screen","Halves damage from Specialattacks for 5 turns.",i,0,30,false,this.allTypes[12],52,0,100); i++;
		this.allAtks[i] = new Attack ("Lovely Kiss","Puts opponent to sleep.",i,0,10,false,this.allTypes[0],2,100,75); i++;
		this.allAtks[i] = new Attack ("Low Kick","Standard attack",i,60,20,true,this.allTypes[1],0,0,100); i++;
		this.allAtks[i] = new Attack ("Meditate","Raises user's Attack.",i,0,40,false,this.allTypes[12],9,100,100); i++;
		this.allAtks[i] = new Attack ("Mega Drain","User recovers half the HP inflicted on opponent.",i,40,15,false,this.allTypes[10],44,100,100); i++;
		this.allAtks[i] = new Attack ("Mega Kick","Standard attack",i,120,5,true,this.allTypes[0],0,0,75); i++;
		this.allAtks[i] = new Attack ("Mega Punch","Standard attack",i,80,20,true,this.allTypes[0],0,0,85); i++;
		this.allAtks[i] = new Attack ("Metronome","User performs almost any move in the game at random.",i,0,10,false,this.allTypes[0],54,0,100); i++;
		this.allAtks[i] = new Attack ("Mimic","Copies the opponent's last move.",i,0,10,false,this.allTypes[0],54,0,100); i++;
		this.allAtks[i] = new Attack ("Minimize","Sharply raises user's Evasiveness.",i,0,10,false,this.allTypes[0],54,0,100); i++;
		this.allAtks[i] = new Attack ("Mirror Move","User performs the opponent's last move.",i,0,20,false,this.allTypes[2],54,0,100); i++;
		this.allAtks[i] = new Attack ("Night Shade","Inflicts damage equal to user's level.",i,0,15,false,this.allTypes[7],53,0,100); i++;
		this.allAtks[i] = new Attack ("Pay Day","Standard attack",i,40,20,true,this.allTypes[0],0,0,100); i++;
		this.allAtks[i] = new Attack ("Peck","Standard attack",i,35,35,true,this.allTypes[2],0,0,100); i++;
		this.allAtks[i] = new Attack ("Petal Dance","User attacks for 2-3 turns but then becomes confused.",i,120,10,false,this.allTypes[10],54,0,100); i++;
		this.allAtks[i] = new Attack ("Pin Missile","Hits 2-5 times in one turn.",i,25,20,true,this.allTypes[6],46,0,95); i++;
		this.allAtks[i] = new Attack ("Poison Gas","Poisons opponent.",i,0,40,false,this.allTypes[3],3,100,90); i++;
		this.allAtks[i] = new Attack ("Poison Powder","Poisons opponent.",i,0,35,false,this.allTypes[3],3,100,75); i++;
		this.allAtks[i] = new Attack ("Poison Sting","May poison the opponent.",i,15,35,true,this.allTypes[3],3,30,100); i++;
		this.allAtks[i] = new Attack ("Pound","Standard attack",i,40,35,true,this.allTypes[0],0,0,100); i++;
		this.allAtks[i] = new Attack ("Psybeam","May confuse opponent.",i,65,20,false,this.allTypes[12],6,10,100); i++;
		this.allAtks[i] = new Attack ("Psychic","May lower opponent's SpecialDefense.",i,90,10,false,this.allTypes[12],32,10,100); i++;
		this.allAtks[i] = new Attack ("Psywave","Inflicts damage 50-150% of user's level.",i,0,15,false,this.allTypes[12],53,0,80); i++;
		this.allAtks[i] = new Attack ("Quick Attack","User attacks first.",i,40,30,true,this.allTypes[0],51,0,100); i++;
		this.allAtks[i] = new Attack ("Rage","Raises user's Attack when hit.",i,20,20,true,this.allTypes[0],9,100,100); i++;
		this.allAtks[i] = new Attack ("Razor Leaf","High critical hit ratio.",i,55,25,true,this.allTypes[10],47,100,95); i++;
		this.allAtks[i] = new Attack ("Razor Wind","Charges on first turn, attacks on second. High critical hit ratio.",i,80,10,false,this.allTypes[0],54,0,100); i++;
		this.allAtks[i] = new Attack ("Recover","User recovers half its max HP.",i,0,10,false,this.allTypes[0],45,100,100); i++;
		this.allAtks[i] = new Attack ("Reflect","Halves damage from Physical attacks for 5 turns.",i,0,20,false,this.allTypes[12],52,0,100); i++;
		this.allAtks[i] = new Attack ("Rest","User sleeps for 2 turns, but user is fully healed.",i,0,10,false,this.allTypes[12],54,0,100); i++;
		this.allAtks[i] = new Attack ("Roar","In battles, the opponent switches. In the wild, the Pokémon runs.",i,0,20,false,this.allTypes[0],54,100,100); i++;
		this.allAtks[i] = new Attack ("Rock Slide","May cause flinching.",i,75,10,true,this.allTypes[5],43,30,90); i++;
		this.allAtks[i] = new Attack ("Rock Throw","Standard attack",i,50,15,true,this.allTypes[5],0,0,90); i++;
		this.allAtks[i] = new Attack ("Rolling Kick","May cause flinching.",i,60,15,true,this.allTypes[1],43,30,85); i++;
		this.allAtks[i] = new Attack ("Sand Attack","Lowers opponent's Accuracy.",i,0,15,false,this.allTypes[4],40,0,100); i++;
		this.allAtks[i] = new Attack ("Scratch","Standard attack",i,40,35,true,this.allTypes[0],0,0,100); i++;
		this.allAtks[i] = new Attack ("Screech","Sharply lowers opponent's Defense.",i,0,40,false,this.allTypes[0],19,100,85); i++;
		this.allAtks[i] = new Attack ("Seismic Toss","Inflicts damage equal to user's level.",i,0,20,true,this.allTypes[1],53,0,100); i++;
		this.allAtks[i] = new Attack ("Self-Destruct","User faints.",i,200,5,true,this.allTypes[0],50,0,100); i++;
		this.allAtks[i] = new Attack ("Sharpen","Raises user's Attack.",i,0,30,false,this.allTypes[0],9,0,100); i++;
		this.allAtks[i] = new Attack ("Sing","Puts opponent to sleep.",i,0,15,false,this.allTypes[0],2,100,55); i++;
		this.allAtks[i] = new Attack ("Skull Bash","Raises Defense on first turn, attacks on second.",i,130,10,true,this.allTypes[0],48,0,100); i++;
		this.allAtks[i] = new Attack ("Sky Attack","Charges on first turn, attacks on second. May cause flinching.",i,140,5,true,this.allTypes[2],54,30,90); i++;
		this.allAtks[i] = new Attack ("Slam","Standard attack",i,80,20,true,this.allTypes[0],0,0,75); i++;
		this.allAtks[i] = new Attack ("Slash","High critical hit ratio.",i,70,20,true,this.allTypes[0],47,0,100); i++;
		this.allAtks[i] = new Attack ("Sleep Powder","Puts opponent to sleep.",i,0,15,false,this.allTypes[10],2,100,75); i++;
		this.allAtks[i] = new Attack ("Sludge","May poison opponent.",i,65,20,false,this.allTypes[3],3,30,100); i++;
		this.allAtks[i] = new Attack ("Smog","May poison opponent.",i,30,20,false,this.allTypes[3],3,40,70); i++;
		this.allAtks[i] = new Attack ("Smokescreen","Lowers opponent's Accuracy.",i,0,20,false,this.allTypes[0],40,0,100); i++;
		this.allAtks[i] = new Attack ("Soft-Boiled","User recovers half its max HP.",i,0,10,false,this.allTypes[0],45,0,100); i++;
		this.allAtks[i] = new Attack ("Solar Beam","Charges on first turn, attacks on second.",i,120,10,false,this.allTypes[10],48,0,100); i++;
		this.allAtks[i] = new Attack ("Sonic Boom","Always inflicts 20 HP.",i,0,20,false,this.allTypes[0],53,0,90); i++;
		this.allAtks[i] = new Attack ("Spike Cannon","Hits 2-5 times in one turn.",i,20,15,true,this.allTypes[0],0,0,100); i++;
		this.allAtks[i] = new Attack ("Splash","Doesn't do ANYTHING.",i,0,40,false,this.allTypes[0],0,100,100); i++;
		this.allAtks[i] = new Attack ("Spore","Puts opponent to sleep.",i,0,15,false,this.allTypes[10],2,100,100); i++;
		this.allAtks[i] = new Attack ("Stomp","May cause flinching.",i,65,20,true,this.allTypes[0],43,30,100); i++;
		this.allAtks[i] = new Attack ("Strength","Standard attack",i,80,15,true,this.allTypes[0],0,0,100); i++;
		this.allAtks[i] = new Attack ("String Shot","Sharply lowers opponent's Speed.",i,0,40,false,this.allTypes[6],28,100,95); i++;
		this.allAtks[i] = new Attack ("Struggle","Only usable when all PP are gone. Hurts the user.",i,50,1000,true,this.allTypes[0],54,0,100); i++;
		this.allAtks[i] = new Attack ("Stun Spore","Paralyzes opponent.",i,0,30,false,this.allTypes[10],1,100,75); i++;
		this.allAtks[i] = new Attack ("Submission","User receives recoil damage.",i,80,20,true,this.allTypes[1],49,0,80); i++;
		this.allAtks[i] = new Attack ("Substitute","Uses HP to create a decoy that takes hits.",i,0,10,false,this.allTypes[0],54,0,100); i++;
		this.allAtks[i] = new Attack ("Super Fang","Always takes off half of the opponent's HP.",i,0,10,true,this.allTypes[0],53,0,90); i++;
		this.allAtks[i] = new Attack ("Supersonic","Confuses opponent.",i,0,20,false,this.allTypes[0],6,100,55); i++;
		this.allAtks[i] = new Attack ("Surf","Standard attack.",i,90,15,false,this.allTypes[9],0,0,100); i++;
		this.allAtks[i] = new Attack ("Swift","Ignores Accuracy and Evasiveness.",i,60,20,false,this.allTypes[0],54,0,100); i++;
		this.allAtks[i] = new Attack ("Swords Dance","Sharply raises user's Attack.",i,0,20,false,this.allTypes[0],13,100,100); i++;
		this.allAtks[i] = new Attack ("Tackle","Standard attack",i,40,35,true,this.allTypes[0],0,0,100); i++;
		this.allAtks[i] = new Attack ("Tail Whip","Lowers opponent's Defense.",i,0,30,false,this.allTypes[0],16,100,100); i++;
		this.allAtks[i] = new Attack ("Take Down","User receives recoil damage.",i,90,20,true,this.allTypes[0],49,0,85); i++;
		this.allAtks[i] = new Attack ("Thrash","User attacks for 2-3 turns but then becomes confused.",i,120,10,true,this.allTypes[0],54,0,100); i++;
		this.allAtks[i] = new Attack ("Thunder","May paralyze opponent.",i,110,10,false,this.allTypes[11],1,30,70); i++;
		this.allAtks[i] = new Attack ("Thunder Punch","May paralyze opponent.",i,75,15,true,this.allTypes[11],1,10,100); i++;
		this.allAtks[i] = new Attack ("Thunder Shock","May paralyze opponent.",i,40,30,false,this.allTypes[11],1,10,100); i++;
		this.allAtks[i] = new Attack ("Thunder Wave","Paralyzes opponent.",i,0,20,false,this.allTypes[11],1,100,90); i++;
		this.allAtks[i] = new Attack ("Thunderbolt","May paralyze opponent.",i,90,15,false,this.allTypes[11],1,10,100); i++;
		this.allAtks[i] = new Attack ("Toxic","Badly poisons opponent.",i,0,10,false,this.allTypes[3],3,100,90); i++;
		this.allAtks[i] = new Attack ("Transform","User takes on the form and attacks of the opponent.",i,0,10,false,this.allTypes[0],54,0,100); i++;
		this.allAtks[i] = new Attack ("Tri Attack","May paralyze, burn or freeze opponent.",i,80,10,false,this.allTypes[0],54,0,100); i++;
		this.allAtks[i] = new Attack ("Twineedle","Hits twice in one turn. May poison opponent.",i,25,20,true,this.allTypes[6],46,20,100); i++;
		this.allAtks[i] = new Attack ("Vice Grip","Standard attack",i,55,30,true,this.allTypes[0],0,0,100); i++;
		this.allAtks[i] = new Attack ("Vine Whip","Standard attack",i,45,25,true,this.allTypes[10],0,0,100); i++;
		this.allAtks[i] = new Attack ("Water Gun","Standard attack",i,40,25,false,this.allTypes[9],0,0,100); i++;
		this.allAtks[i] = new Attack ("Waterfall","May cause flinching.",i,80,15,true,this.allTypes[9],43,20,100); i++;
		this.allAtks[i] = new Attack ("Whirlwind","In battles, the opponent switches. In the wild, the Pokémon runs.",i,0,20,false,this.allTypes[0],54,0,100); i++;
		this.allAtks[i] = new Attack ("Wing Attack","Standard attack",i,60,35,true,this.allTypes[2],0,0,100); i++;
		this.allAtks[i] = new Attack ("Withdraw","Raises user's Defense.",i,0,40,false,this.allTypes[9],17,100,100); i++;
		this.allAtks[i] = new Attack ("Wrap","Traps opponent, damaging them for 4-5 turns.",i,15,20,true,this.allTypes[0],55,0,90); i++;
